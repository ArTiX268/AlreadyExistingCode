...
public class InputManager : MonoBehaviour
{
    ...
    [HideInInspector] public static InputAction jumpInput;
    [HideInInspector] public static InputAction leftRightInput;
    ...
    private void OnEnable()
    {
        ...
        leftRightInput = inputActions.Player.LeftRight;
        leftRightInput.Enable();
    }
