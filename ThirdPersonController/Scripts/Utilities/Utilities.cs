...
{
    public static Vector3 PutVectorOnXZPlane(this Vector3 vector) => new Vector3(vector.x, 0, vector.z).normalized;

    public static Vector3 PutVectorOnZYPlane(this Vector3 vector) => new Vector3(0, vector.x, vector.z).normalized;
}
